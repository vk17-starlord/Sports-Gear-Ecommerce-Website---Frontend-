    ...
    <MainMenu></MainMenu>    
     ...
     <div className="col min-h-[90vh]  md:min-h-[auto]">
      <div className="grid w-full   md:flex md:flex-col md:flex-col-reverse grid-cols-[2fr_10fr]">
        ...
        <div className="p-4 main-img  h-full md:h-auto ">
               <img src={views[isActive]}  alt="xyz" />
        </div>
      </div>
     </div>
     ...
     <div className="text-left col min-h-[90vh] px-5 py-3  ">
        ...
        <div className="store">
          ...
          <p className='font-medium md:text-sm text-[16px] opacity-50 align-center'><i class='align-top text-xl bx bxs-store-alt'>xyz</i> Available on stores </p>
      ...
      <div className="border-t border-b w-full md:grid-cols-2 gap-4 grid grid-cols-3 py-4">
       ...
       <div className="flex">
       <img className='max-w-[32px] h-[40px]' src="https://contents.mediadecathlon.com/s810456/k$3d1c34a67fc4a7d2659a8f40f2f68cb7/Warranty.png" alt="xyz" />
        <div>
       ...
       <div className="flex">
       <img className='max-w-[32px] h-[40px]' src="https://contents.mediadecathlon.com/s810453/k$b01109de2bacb669e5db58aefa3c6ee9/Free%20delivery.png" alt="xyz" />
        <div>
       ...
       <div className="flex">
       <img className='max-w-[32px] h-[32px]' src="https://contents.mediadecathlon.com/s810455/k$5d275c8ba3f1f586032fc19f5bacf57f/90%20dats%20return.png" alt="xyz" />
        <div>
     ...
     <div className="size flex my-4">
       <h1 className='font-bold my-2'>SIZE -</h1>
       {
         product.size.map((ele,index)=>
          index===size ?  <button onClick={()=>{
            setsize(index)
          }} className="mx-2 text-[16px]  w-[40px] h-[40px] flex items-center justify-center rounded-full bg-[#405DF8] text-white font-bold">
          {ele}
        </button>: <button onClick={()=>{
          setsize(index)
        }} className="mx-2 text-[16px] font-medium w-[40px] h-[40px] flex items-center justify-center rounded-full bg-[#E5E5E5]">
           {ele}
         </button>
          )
       }
     ...
     <button className ="cta flex justify-center items-center md:text-sm md:px-2  bg-[#405DF8] mt-2 w-full text-[#fff] rounded-md px-10 hover:bg-black py-3 font-semibold  text-md ">Add To Cart <i className='bx bxs-cart-alt txyzext-xl align-top'></i> </button>
     <button className ="cta flex justify-center items-center md:text-sm md:px-2  bg-[#F3F5FF] mt-2 w-full text-[#405DF8] rounded-md px-10 border-2 border-[#405DF8]  py-3 font-semibold text-md ">Add To Wishlist <i className='bx bx-bookmark-heart text-xl align-top'></i> </button>
     </div>
     </div>
    </div>
 </div>
